...
if(entriesEl){
document.getElementById('entries').innerHTML = window.entries.map((entry, index) => `
    <div class="w-100">
    <img class="fl mr3 mb2" src="./${entry.image}" alt="screenshot of mind of our own app" /> 
    ...
    <p>
        ...
        class="nowrap"
        onmouseover="this.firstElementChild.style.borderBottomColor = '${colours[index % colours.length]}'"
        onmouseout="this.firstElementChild.style.borderBottomColor = null"
        onfocus="this.firstElementChild.style.borderBottomColor = '${colours[index % colours.length]}'"
        onblur="this.firstElementChild.style.borderBottomColor = null"
        >
        <span class="our-work-entry-link" data-color="${colours[index % colours.length]}">
...
const profiles = [
    ...
    description: 'At vero eos et accusam et justo duo dolores et ea rebumumy sed tempor et et invidunt justo labore Stet clita ea et gubergren. Rebumumy sed tempor. At vero eos et accusam et'
    },
    {
    name: 'Bruce Wayne',
    image: './thetribe1.png',
    title: 'Back-end Developer',
    description: 'At vero eos et accusam et justo duo dolores et ea, at vero eos et accusam et justo duo dolores et ea rebumumy sed tempor. rebumumy sed tempor et et invidunt justo labore Stet clita ea et gubergren. Rebumumy sed tempor. At vero eos et accusam et justo duo dolores et ea rebumumy sed tempor.'
    },
    {
    name: 'Bruce Wayne',
    image: './thetribe1.png',
    title: 'Back-end Developer',
    description: 'At vero eos et accusam et justo duo dolores et ea rebumumy sed tempor et et invidunt justo labore Stet clita ea et gubergren. Rebumumy sed tempor. At vero eos et accusam et justo duo dolores et ea rebumumy sed tempor.'
    },
    {
    name: 'Bruce Wayne',
    image: './thetribe1.png',
...
const profilesEl = document.getElementById('profiles');
    ...
    <button type="button" class="flip-button" onclick="flip(this)">
        ...
        <span class="flipper">
            ...
            <span class="absolute mb2 bottom-1 right-0">
                <span class="text-name w-100 fw7">
                ${profile.name}
        ...
        <span class="back">
                <h4>${profile.name}</h4>
                <h5>${profile.title}</h5>
                <span class="smallparagraph">${profile.description}</span>
        </span>
        </span>
        </span>
    </button>
...
window.flip = el => {
    Array.from(document.getElementsByClassName('flip-button')).filter(item => {
    return item !== el;
    }).forEach(item => {
