...
const activeLinkStyles = css.resolve`
  ...
  a::after {
    ...
    background-image: url("data:image/svg+xml;charset=UTF-8,<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' height='8px' viewBox='0 0 9 6' enable-background='new 0 0 9 6' xml:space='preserve'><polygon stroke='%23fb37f1' points='4.5,4.5 0,0 0,1.208 4.5,5.708 9,1.208 9,0 '/> </svg>");
