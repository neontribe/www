...
export const BottomParagraphOne = () => (
  <Text size="normal">
    <p>
      We&#39;re always happy to hear from people who like the sound of
      Neontribe, and want to grow their skills as a developer, or in user
      research or product management.{' '}
    </p>
  </Text>
)
...
export const BottomParagraphTwo = () => (
  <Text size="normal">
    <p>
      Maybe you’re already experienced, or maybe you&#39;re just getting
      ...
      and the skills you want to gain and we’ll let you know if we think there’s
      a place for us to start talking. That&#39;s it.
    </p>
  </Text>
)
